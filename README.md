...
[![Version](https://img.shields.io/badge/version-11.0.0-72e4ff)](https://github.com/QXF19/qxfMCAI/releases)
...
- 新增可放在任意方块上的三合一实体棋盘；五子棋、中国象棋、13×13 围棋均在独立界面操作，不再刷聊天框
...
2. 下载 `qxfmcai-11.0.0.jar`，放入客户端与服务端的 `mods` 文件夹。
...
- `/mcai board`：领取可放置的五子棋/象棋/围棋三合一棋盘
...
输出：`build/libs/qxfmcai-11.0.0.jar`。
